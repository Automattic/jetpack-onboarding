	...
	render: function() {
		return (
			...
			<WelcomeSection id="welcome__site-title">
				...
				<h4>Enter a Title and Tagline</h4>
				<form onSubmit={this.handleSubmit}>
					<input type="text" name="site_title" id="site-title" autoComplete="off" onChange={this.handleChangeTitle} value={this.state.title} placeholder="Site Title (this can be changed later)" />
					<input type="text" name="site_description" id="site-description" autoComplete="off" onChange={this.handleChangeDescription} value={this.state.description} placeholder="Tagline (this can be changed later)" />
					<p className="submit">
